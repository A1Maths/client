                                ...
                                <div className="col-md-6 col-lg-7 d-flex align-items-center">
                                    <div className="card-body p-4 p-lg-5 text-black">
                                        ...
                                        <form onSubmit={handleSubmit}>
                                            ...
                                            <input className="form-control form-control-lg mb-4" onChange={(e) => setEmail(e.target.value)} value={email} type="email" id="email" placeholder='Enter your email'/>
                                            {/* <label className="form-label" htmlFor="password">Password</label> */}
                                            <input className="form-control form-control-lg mb-4" onChange={(e) => setPassword(e.target.value)} value={password} type="password" id="password" placeholder='Enter your password'/>
                                            <div className="pt-1 mb-4">
                                                <button className="btn btn-dark btn-lg btn-block" style={{width: '100%'}}>Login</button>
                                            </div>
                                        </form>
